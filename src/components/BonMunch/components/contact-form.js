...
export default class extends React.Component {
    ...
    this.validators = {
      name: name =>
        validateFirstName(name)
          ? { isValid: true, error: "" }
          : { isValid: false, error: "The name is required" },
      email: email =>
        validateEmail(email)
          ? { isValid: true, error: "" }
          : { isValid: false, error: "The email address is required" },
      phone: phone =>
        validatePhone(phone)
          ? { isValid: true, error: "" }
          : { isValid: false, error: "Telephone number is required" },
      message: message =>
        validateFirstName(message)
          ? { isValid: true, error: "" }
          : { isValid: false, error: "The message is required" }
    };
  }
  ...
  render() {
    ...
    return (
      <div>
        {!showNameError && <label htmlFor="name">Name</label>}
        {showNameError && (
        ...
        {!showPhoneError && <label htmlFor="phone">Phone</label>}
        {showPhoneError && (
        ...
        {!showMessageError && <label htmlFor="message">Message</label>}
        {showMessageError && (
        ...
        {submitSuccessful && (
          <label className="success contact__form__success">
            The message was sent. Thank you!
          </label>
        )}
      </div>
    );
